...
int main(int argc, char* argv[]) {
    ...
    if (argc < 2) {
        ...
        cerr << "Performs a heuristic search (arXiv:2311.15199v2 constraints + optimal shaking) for partitions" << endl;
    ...
    cout << "Starting heuristic search (arXiv:2311.15199v2 constraints with incremental shake, early stop window = " << EARLY_STOP_WINDOW
    ...
    if (has_previous_results) {
        ...
        outfile << "Heuristic search results (arXiv:2311.15199v2 constraints with optimal shake, early stop window = " << EARLY_STOP_WINDOW
                << ", stored partitions n = " << STORED_MAX_PARTITIONS_N
                << ", stored partitions n-1 = " << STORED_MAX_PARTITIONS_N_MINUS_1
